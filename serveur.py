...
def create_new_mission():
    ...
    nom = str(cur_cas.fetchall()).split("'")[1]
    ...
    try:
        ...
        statu_crea = 0
        cur.execute("INSERT INTO mission.suivi_mission(ID,ID_USER,NAME,DATE_CREA,STATUE) VALUES (?,?,?,?,?)",(ID.__str__(),user_id,nom[0],val["DATE_AJD"],statu_crea))
